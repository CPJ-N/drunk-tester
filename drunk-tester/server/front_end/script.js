...
login_instruction.innerText =
  "Login to continue. An account will be created under the username if you dont' have one already."; // Insert text
...
let login_button = document.getElementById("myBtn");
...
function login_click() {
  ...
  fetch(
    `http://localhost:3000/authenticate?username=${usernameInput.value}&password=${passInput.value}`
  )
    .then((response) => {
